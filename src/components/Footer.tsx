...
export default function Footer() {
    return (
        <footer className="pb-5">
            <div className="max-w-6xl pt-15 pb-5 mx-auto flex items-center justify-between border-b-1">
                <img src={MJCLogo} alt="Martins Java Code Logo" className="w-80"/>
                <SocialMedia />
            </div>
            <div className="max-w-6xl pt-5 mx-auto flex items-center justify-between">
